"""This script is used to Split Air SAR Ship1.0
...
import numpy as np
import math
from splitImage.dota_utils import GetFileFromThisRootDir
import cv2
import shapely.geometry as shgeo
import splitImage.dota_utils as util
import copy
...
if __name__ == '__main__':
    split = splitbase(basepath='/home/fzh/Data/SAR-Ship-1.0/train/',
                      outpath='/home/fzh/Data/SAR-Ship-1.0/trainSplit/',
                      code='utf-8',
                      gap=256,
                      subsize=512,
                      thresh=0.7,
