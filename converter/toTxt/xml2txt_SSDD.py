"""This script is used to convert xml file to txt file for SSDD Dataset."""
...
if __name__ == '__main__':
    trans = xml2txt(data_path=r'/data/fzh/SSDD_data/',
                    xml_folder_name='valxml/',
                    txt_folder_name='valtxt/')
