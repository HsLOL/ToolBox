...
class xml2json(object):
    ...
    def annotation(self, xmin, ymin, xmax, ymax, cls_name, img_id):
        ...
        single_obj['image_id'] = img_id  # int
        single_obj['category_id'] = self.categories.index(cls_name) + 1  # int
        single_obj['segmentation'] = []
        single_obj['area'] = obj_width * obj_height  # float
        single_obj['bbox'] = [xmin, ymin, obj_width, obj_height]  # "bbox": [xmin, ymin, width, height]
        single_obj['iscrowd'] = 0  # int
        self.anno_id += 1
        return single_obj
    ...
    def save_json(self):
        ...
        for idx, name in enumerate(self.categories):
            single_category = {'id': idx + 1, 'name': name, 'supercategory': str('none')}
...
if __name__ == '__main__':
    trans = xml2json(data_path=r'/data/fzh/SSDD_data/',
                     ...
                     xml_folder_name='trainxml/',
                     json_folder_name='mmdet_annotations',
